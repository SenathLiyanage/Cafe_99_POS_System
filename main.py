...
# forget button
forgetButton = Button(login_window,text='forgrot Password?', bd=0, bg=Headbg, fg=Headfg, activebackground=Headbg, activeforeground='NavajoWhite4', cursor='hand2')
forgetButton.place(x=370,y=300)

# login button
loginButton = Button(login_window,text='Login',font=('Gilroy',16,'bold'), bd=0, width=18, bg=Headfg, fg=Headbg, activebackground='NavajoWhite4', activeforeground=Headbg, cursor='hand2')
...
createButton = Button(login_window,text='Create new account', font=('Gilroy',8,'bold'), bd=0, bg=Headbg, fg='red', activebackground=Headbg, activeforeground='NavajoWhite4', cursor='hand2')
